...
export const artworks = [
  ...
  {
    id: "artwork-wearable-casa-space-cabinet-planets",
    exhibitionId: "exhibition-wearable-casa-2024",
    slug: "space-cabinet-planet-series",
    title: "Space Cabinet·Planet Series",
    artistName: "Atelier Biagetti",
    collaborator: "MCM",
    series: "Planet Small·Medium·Big",
    type: "구형 다기능 수납·패션·웰니스 오브제 작품군",
    form: "행성과 지구 밖 탐사를 연상시키는 구형 구조",
    location: "MCM HAUS 1F 우주·웨어러블 오브제 공간",
    summary:
      "행성과 외계 탐험에서 영감을 받은 세 가지 크기의 구형 오브제가 주얼리 미니백, 캐비닛과 웰니스 시팅볼로 기능하는 작품군입니다.",
    description:
      "Planet Small은 거울이 포함된 주얼리 미니백, Planet Medium은 후광을 갖춘 구형 미니 캐비닛, Planet Big은 공기를 주입해 사용하는 대형 웰니스 시팅볼입니다. 크기에 따라 패션 액세서리에서 가구까지 확장되지만 모두 휴대성과 다목적 사용이라는 동일한 DNA를 공유합니다.",
    interpretation:
      "행성처럼 완결된 구형 오브제는 새로운 장소를 탐험하는 이동자의 작은 세계를 상징합니다. 하나의 시리즈가 몸에 지니는 가방, 집 안의 수납장과 몸을 지지하는 좌석으로 크기를 바꾸며 패션과 공간의 경계를 확장합니다.",
    viewingTips: [
      "Small, Medium과 Big의 크기가 달라질 때 오브제의 기능이 어떻게 변화하는지 비교해 보세요.",
      "모든 형태에서 반복되는 구형 구조와 이중 용도를 찾아보세요.",
    ],
    keywords: ["행성", "우주", "미니백", "캐비닛", "시팅볼", "다목적"],
    tmi: [
    ...
    contents: [
      "Planet Small — 거울이 포함된 주얼리 미니백",
      "Planet Medium — 후광이 있는 구형 미니 캐비닛",
      "Planet Big — 공기 주입식 대형 웰니스 시팅볼",
    ],
    displayOrder: 4,
    source: wearableCasaSource,
  },
  ...
  {
    id: "artwork-wearable-casa-mindteaser-series",
    exhibitionId: "exhibition-wearable-casa-2024",
    slug: "mindteaser-series",
    title: "Mind Teaser Series",
    artistName: "Atelier Biagetti",
    collaborator: "MCM",
